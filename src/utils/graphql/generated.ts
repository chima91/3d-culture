...
export type InsertUserMutation = { __typename?: 'mutation_root', insert_users_one?: { __typename?: 'users', created_at: any, id: string, name: string, profile_photo_url: string, updated_at: any } | null | undefined };
